...
const SCREEN_SCRIPTS: Record<ScreenId, string[]> = {
  ...
  1: ["Hallo! Ich bin's wieder, Lux.", "Das ist ein Schwan.", "Tipp irgendwo hin, um weiterzumachen."],
  ...
  5: ["Am Ende des Weges wartet eine Figur.", "Die Dame kann sie freundlich begrüßen."],
...
export default function Quest5() {
  ...
  async function handleQuestComplete() {
    await saveQuestFortschrittLocal("quest5", { sterne: 3, abgeschlossen: true, letzterSchritt: "screen7" });
  }
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {screen === 7 && (
        <Pressable style={styles.tapArea} onPress={() => navigation.navigate("Quest6")}>
          <QuestGeschafft>
